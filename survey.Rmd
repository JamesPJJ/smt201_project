...
You will get the areas with different colors classification which represent different population density in east Kalimantan area.

Repeat the same steps for other factors such as education, religions, etc.

## 2.0 Colored StudyArea by district
...
The **studyArea** layer will be colored by four districts.

![](img/coloredStudyArea3.png)

## 3.0 Electricity Power house 
### 3.1 Merge layers

* On the menu bar, Click **Vector** -> **Data Management Tools** -> **Merge Vector Layers**.
