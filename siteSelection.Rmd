...
## 1.5 Computing proximity for all the merged layers

### 1.5.1 Creating attribute field for rasterising
...
### 1.5.2 Rasterising Merged_Street layer
...
###1.5.3 Working with Proximity function of QGIS
...
# 2.0 Raster-based GIS Multiple‐Criteria Decision Analysis (GIS-MCDA)
## 2.1 Standardising the factor scores
...
# 4.0 Computing the Suitability Layer
...
# 5.0  Identifying Suitable Sites
...
# 6.0  Final steps for site selections:

![](img/siteSelection39.png)
For reference layer, choose one of the layers used in the equation
